...
const menuItems = computed(() => {
  return (
    leftMenuData.leftMenuItems[props.leftMenuType] ||
    leftMenuData.leftMenuItems["default"] ||
    []
  );
});
...
<template>
  <div
    class="w-[180px] min-w-[180px] h-full bg-[#d4d0c8] border-r-2 border-[#0a2a5e] p-2 overflow-auto"
  >
    <div class="mb-2 pb-1 border-b border-[#a7a39a]">
      <span
        class="text-[11px] font-bold text-[#0a2a5e] font-tahoma tracking-wide"
        >Common Tasks</span
      >
    </div>
    ...
    >
      <img
        :src="item.iconHeader || '/img/icons/side-menu/folder-icon.webp'"
        alt="folder"
