...
const volumeIconSrc = computed(() => {
  return volume.value === 0
    ? `${import.meta.env.BASE_URL}img/icons/mute-icon-sm.webp`
    : `${import.meta.env.BASE_URL}img/icons/volume-icon-sm.webp`;
});
...
const flagSrc = computed(() => {
  return `${import.meta.env.BASE_URL}img/icons/langs/flag-${currentLocale.value}.webp`;
});
</script>
